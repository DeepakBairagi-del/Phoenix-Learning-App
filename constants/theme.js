...
export const darkTheme = {
    ...
    backgroundColor9: COLORS.primary,
    backgroundColor10: COLORS.gray85,
    lineDivider: COLORS.gray70,
    borderColor1: COLORS.gray70,
    borderColor2: COLORS.gray70,
    borderColor3: COLORS.gray40,
    ...
    tintColor2: COLORS.gray50,
    dotColor1: COLORS.white,
    dotColor2: COLORS.primary,
    checkIconOn: icons.checkbox_on_dark,
    checkIconOff: icons.checkbox_off_dark
}
...
export const lightTheme = {
    ...
    backgroundColor10: COLORS.additionalColor9,
    lineDivider: COLORS.gray20,
    borderColor1: COLORS.white,
    borderColor2: COLORS.black,
    borderColor3: COLORS.additionalColor9,
    ...
    tintColor2: COLORS.gray20,
    dotColor1: COLORS.gray20,
    dotColor2: COLORS.primary3,
    checkIconOn: icons.checkbox_on,
    checkIconOff: icons.checkbox_off
}
